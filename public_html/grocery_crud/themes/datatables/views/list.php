		...
		<tr>
			...
			<td class="td-action">
				<ul class='tools list-unstyled table-menu'>
					...
					<?php if (!$unset_delete):?>
					<li>
					<a href='<?php echo $row->delete_url?>' title='<?php echo $this->l('list_delete')?> <?php echo $subject?>' class="delete-row text-danger"><i class='fa fa-trash text-danger'></i>&nbsp;Delete</a>					
					</li>
				<?php endif ?>
				</ul>
			</td>
