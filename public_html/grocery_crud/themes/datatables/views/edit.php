...
<div class="flexigrid crud-form box" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div id='main-table-box' class="box-body">
		...
		<div id='report-error' style="display: none" class='report-div error alert alert-danger' role="alert"></div>
		<div id='report-success' style="display: none" class='report-div success alert alert-success'></div>
	</div>
		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<p>
					...
					<?php 	} ?>
					<span class='small-loading' id='FormLoading' style="display: none"><img src="<?php echo base_url('svg/loading-spin-primary.svg') ?>" alt="loading..."> <?php echo $this->l('form_insert_loading'); ?></span>
				</p>
			</div>
		</div>
	</div>
