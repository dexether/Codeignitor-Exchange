...
<div class="flexigrid crud-form box" data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div id='main-table-box' class="box-body">
		...
		<div id='report-error' class='report-div error alert alert-danger' role="alert" style="display: none"></div>
		<div id='report-success' class='report-div success alert alert-success' style="display: none"></div>
	</div>
		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<p>
					...
					<?php 	} ?>
					<span class='small-loading' style="display: none" id='FormLoading'><img src="<?php echo base_url('svg/loading-spin-primary.svg') ?>" alt="loading..."> <?php echo $this->l('form_insert_loading'); ?></span>
				</p>
			</div>
		</div>
	</div>
