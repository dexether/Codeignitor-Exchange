...
(function($) {
	...
	$.formValidator.defaults = {
		...
		errorDiv		:	'#warn',
		errorMsg		: 	{
								reqString		:	'String Required',
								reqDate			:	'<b>Date</b>! Required',
								reqNum			:	'Number Required',
								reqMailNotValid	:	'E-mail not Valid',
								reqMailEmpty	:	'E-mail Required',
								reqSame			:	'Required same Name',
								reqBoth			:	'Fill the required field',
								reqMin			:	'Minimum character Required'
							},
		customErrMsg	:	'',
