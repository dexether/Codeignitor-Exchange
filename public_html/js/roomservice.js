        ...
        for (var i = 0; i < countOfRows; i++) {
            ...
            if (tableValue[i + k * (pageNumber - 1)]) {
                ...
                for (var key in keys) {
                    ...
                    if (templ) {
                        if (keys[key] !== 'Date') row += '<td>' + templ.toFixed(8) + '</td>';else {
                            if (keys[key] !== 'Id') row += '<td>' + tableValue[i + k * (pageNumber - 1)][keys[key]] + '</td>';
                        }
                    }
                }
                if (orderHistory) {
            ...
            for (var i = 0; i < countOfRows; i++) {
                ...
                for (var key in keys) {
                    if (keys[key] !== 'Id') {
                        ...
                        if (templ) {
                            if (keys[key] !== 'Date') row += '<td>' + templ.toFixed(8) + '</td>';else {
                                if (keys[key] !== 'Id') row += '<td>' + tableValue[i][keys[key]] + '</td>';
                            }
                        }
                    } else {
