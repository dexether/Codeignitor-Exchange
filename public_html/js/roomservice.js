...
function ChartMarket() {
    ...
    setTimeout(function () {
        ...
        data.append([Date.UTC(2007, 8, 10), 24.55, 23.88, 23.38, 23.62]);
    }, 5000);

    setTimeout(function () {
        data.append([Date.UTC(2007, 8, 10), 22.55, 23.88, 21.38, 23.62]);
    }, 10000);
        ...
        if (!window.WebSocket) {
            ...
            socket.on('connect', function () {
                ...
                socket.on('data_to_chart', function (msg) {
                    chart = __webpack_require__(0)(msg);
                    //  chart.loadData(msg);
                });
