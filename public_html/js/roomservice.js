        ...
        $.ajax({
            ...
            if (button === 'next') {
                ...
                if (button === 'prevent') {
                    ...
                    if (firstPageInTable > 2) firstPageInTable = firstPageInTable - 2;
                } else {
                    if (button === 'first') {
                        firstPageInTable = 1;
        ...
        for (var i = 0; i < countOfRows; i++) {
            ...
            if (tableValue[i + k * (pageNumber - firstPageInTable)]) {
                ...
                if (rowOfTable.length === 0) {
                    if (countOfRows > $(table).find('tr').length) $(table).append(row);
                } else {
