      ...
      <div class="row">
        ...
        <div class="col-md-9 col-sm-8">
         ...
         <div class="cls_facr_box">
          <h4>Enter your secret code into the Google Authenticator App on your phone or tablet, or <br>add extension in your browser</h4>
          ...
          <h4>To activate 2-Step Verification please enter the code generated by your Google Authenticator App.</h4>
          <?php echo form_open('user/enable_tfa', 'class="form-horizontal" name="activate_form" id="activate_form" method="post"'); ?>
