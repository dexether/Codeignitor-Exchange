            ...
            <div class="row">
                <div class="col-md-6 col-sm-6" id="">
                    <div class="cls_buy_coin">
                        <h4> Buy <?php echo $currency_bid; ?> </h4>
                            <div class="cls_buy_coin_inn">
                                ...
                                <div class="cls_ac_ba"> Available <?php echo $currency_bid; ?>: 
                                    <b><?php //echo number_format((float)$available_btc, 8, '.', ''); ?></b>
                                </div>
  </div>
  </div>
...
<strong>Oops!</strong> <span id="errorMessage"><?php echo $error; ?></span>
  ...
  <div class="form-group">
   ...
   <input type="text" <?php echo $pro; ?> class="form-control numvalid" id="b_btc" maxlength="20" onkeyup='usd_calc_limit("buy"); comm_replace_limit(this);'>
    <small> <?php echo $secondcurrency; ?>  </small>
    ...
    <small> <?php echo $firstcurrency; ?> </small>
  </div>
  </div>
  </div>
...
<div class="col-sm-2 pad-no"> <?php echo $secondcurrency; ?></div>
</div> 
  ...
  <input type="hidden" name="b_fee" id="b_fee" value="" >
    ...
    <div align="center" class=""><button type="button" id="buy_button" class="cls_buy_btn" onclick="return rambo_calculate_limit('buy');" > Buy <?php echo $secondcurrency; ?> </button> </div>
</form>
  ...
  <input type="text" <?php echo $pro; ?> class="form-control numvalid" maxlength="15"  id="bb_btc">
    ...
    <div class="col-md-6 col-sm-6">
    <div class="form-group">
    <label for="exampleInputEmail1">If price rises to : <?php echo $secondcurrency; ?>:</label>
...
<input type="hidden" name="b_fee" id="b_fee" value="" >
    ...
    <div class="cls_line_bot"> </div>
    <div align="center" class=""><button type="button" id="buy_button_stop" class="cls_buy_btn" onclick="return rambo_calculate('buy');" > Buy <?php echo $secondcurrency; ?> </button> </div>
</form>
  ...
  <div class="col-md-6 col-sm-6" id="">
  <div class="cls_buy_coin">
  <h4> Sell <?php echo $secondcurrency; ?> </h4>
  <div class="cls_buy_coin_inn">
  <div class="row">
  <div class="col-md-6 col-sm-6">
...
<option value="stop">Stop Order (Advanced)</option></select> </div>
    ...
    <div class="col-md-6 col-sm-6">
    <div class="cls_ac_ba"> Available <?php echo $secondcurrency; ?>: <b><?php echo number_format((float)$available_usd, 8, '.', ''); ?>  </b> </div>
  </div>
  </div>
...
<strong>Oops!</strong> <span id="errorMessage"><?php echo $error; ?></span>
 ...
 <input type="text" <?php echo $pro; ?> class="form-control numvalid" id="s_btc" maxlength="20" onkeyup='usd_calc_limit("sell"); comm_replace_limit(this);'>
    <small> <?php echo $secondcurrency; ?>  </small>
  ...
  <form class="form-horizontal cls_as">
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-4 control-label"><?php echo $firstcurrency; ?> to Receive </label>
    <div class="col-sm-8">
...
<div class="col-sm-2 pad-no"> <?php echo $secondcurrency; ?></div>
  ...
  <input type="hidden" name="s_fee" id="s_fee" value="" >
    ...
    <div class="cls_line_bot"> </div>
    <div align="center" class=""><button type="button" id="sell_button" class="cls_buy_btn" onclick="return rambo_calculate_limit('sell');" > Sell <?php echo $secondcurrency; ?> </button> </div>
</form>
...
<input type="hidden" name="s_fee" id="s_fee" value="" >
    ...
    <div class="cls_line_bot"> </div>
    <div align="center" class=""><button type="button" id="stop_buy_button" class="cls_buy_btn" onclick="return rambo_calculate('sell');" > Sell <?php echo $secondcurrency; ?> </button> </div>
</form>
